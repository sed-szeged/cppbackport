...
private:
    ...
    std::vector<sqlite3_stmt *> prepStmts{ { getDependencyList_query, getCmdLineForFile_query, getTimestampForFile_query, 
        ...
        setTheNumberOfLinesForFile_query, getTheNumberOfLinesOfFile_query, isActualLineInTheDb_query
    } };
};
