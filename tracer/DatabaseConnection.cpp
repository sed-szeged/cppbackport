...
long DatabaseConnection::addReplacement(int file_id, short transformationId, int startLine, int numberOfLinesReplaced, int numberOfLinesInReplacementText, int from_file_id, int from_start_line, int from_end_line, std::string const &replacement_text) {
    std::lock_guard<std::recursive_mutex> lock(operationIsInProgressMutex);
...
long DatabaseConnection::addReplacement(std::string const &filepath, short transformationId, int startLine, int numberOfLinesReplaced, int numberOfLinesInReplacementText, std::string const &fromPath, int from_start_line, int from_end_line, std::string const &replacement_text) {
    return addReplacement(getIdForFile(filepath), transformationId, startLine, numberOfLinesReplaced, numberOfLinesInReplacementText, getIdForFile(fromPath), from_start_line, from_end_line, replacement_text);
}
