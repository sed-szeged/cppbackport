...
#ifndef BACKPORT_TRANSFORMS_H
#define BACKPORT_TRANSFORMS_H
...
public:
    ...
    /// \brief Registers all available transforms causing them to be made available on the command line.
    ///
    ...
    /// \brief Return an iterator to the start of a container of instantiated transforms.
    const_iterator begin() const { return ChosenTransforms.begin(); }

    /// \brief Return an iterator to the end of a container of instantiated transforms.
